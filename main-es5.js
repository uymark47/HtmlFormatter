...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppViewerViewerComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_exports__["default"] = "<div *ngFor=\"let data of editorService.dataBank\">\n    {{data.formatTitle}} <br>\n    {{data.body}} <br>\n    {{data.formatSource}} <br> <br>\n</div>\n";
    /***/
  },
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      function AppComponent(editorService) {
        ...
        this.editorService.selectData.subscribe(function (res) {
          if (res) {
      ...
      _createClass(AppComponent, [{
        key: "onChangeIndex",
        value: function onChangeIndex(i) {
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _viewer_viewer_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    ...
    var _editor_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    /*! ./editor.service */
    "./src/app/editor.service.ts");
    /* harmony import */
    ...
    var _sort_sort_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
    /*! ./sort/sort.component */
    ...
    var ngx_webstorage_service__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      ...
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_4__["BrowserAnimationsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["ReactiveFormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["FormsModule"], _angular_material_tabs__WEBPACK_IMPORTED_MODULE_8__["MatTabsModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_9__["MatInputModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_12__["MatButtonModule"], _angular_material_form_field__WEBPACK_IMPORTED_MODULE_10__["MatFormFieldModule"], _angular_material_checkbox__WEBPACK_IMPORTED_MODULE_14__["MatCheckboxModule"], _angular_cdk_drag_drop__WEBPACK_IMPORTED_MODULE_15__["DragDropModule"], _angular_material_list__WEBPACK_IMPORTED_MODULE_16__["MatListModule"], ngx_webstorage_service__WEBPACK_IMPORTED_MODULE_17__["StorageServiceModule"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_18__["MatDialogModule"], _angular_material_tooltip__WEBPACK_IMPORTED_MODULE_19__["MatTooltipModule"], _angular_material_autocomplete__WEBPACK_IMPORTED_MODULE_20__["MatAutocompleteModule"], _angular_material_radio__WEBPACK_IMPORTED_MODULE_21__["MatRadioModule"]],
  ...
  /***/
  function srcAppEditorServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "EditNews", function () {
      return EditNews;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "SourceCount", function () {
      return SourceCount;
    });
    /* harmony export (binding) */
    ...
    News = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: "root"
    })], News);
    ...
    var SourceCount = function SourceCount() {
      _classCallCheck(this, SourceCount);
    ...
    /*#__PURE__*/
    function () {
      function EditorService(storage) {
      ...
      _createClass(EditorService, [{
        key: "select",
        value: function select(index, item) {
              ...
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    ...
                    data.title = data.title.trim(); // if (data.rank && data.rank > 0) {
                    //   data.rank -= 1;
        ...
        key: "edit",
        value: function edit(data, index) {
          return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0,
          /*#__PURE__*/
            ...
            return regeneratorRuntime.wrap(function _callee2$(_context2) {
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    console.log(index);
                    this.dataBank[index] = data; // if (data.rank && data.rank > 0) {
                    //   this.dataBank = [
        ...
        value: function formatDataBank() {
          ...
          try {
            for (var _iterator = this.dataBank[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
              var data = _step.value;
              data.formatTitle = "<strong><em><a href = \"".concat(data.link, "\">").concat(data.title, "</a></em></strong>");
              data.formatSource = data.paywall ? "<em>-- ".concat(data.source, "</em> (paywall)") : "<em>-- ".concat(data.source, "</em>");
            }
          } catch (err) {
        ...
        value: function drop(event) {
          var changeItemIndex = this.dataBank[event.previousIndex];
          this.dataBank = [].concat(_toConsumableArray(lodash__WEBPACK_IMPORTED_MODULE_2__["slice"](this.dataBank, 0, event.previousIndex)), _toConsumableArray(lodash__WEBPACK_IMPORTED_MODULE_2__["slice"](this.dataBank, event.previousIndex + 1, this.dataBank.length)));
          changeItemIndex.rank = event.currentIndex ? this.dataBank[event.currentIndex - 1].rank : 1;
          this.dataBank.splice(event.currentIndex, 0, changeItemIndex);
          this.formatDataBank();
        }
      }, {
        key: "removeOne",
        value: function removeOne(index) {
        ...
        key: "checkAndAddSource",
        value: function checkAndAddSource(newSource) {
          ...
          if (this.sources && this.sources.length > 0) {
            ...
            try {
              for (var _iterator2 = this.sources[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
            ...
            if (!sourceExist) {
              this.sources = [newSource].concat(_toConsumableArray(this.sources));
        ...
        value: function countSources() {
          ...
          try {
            for (var _iterator3 = this.dataBank[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
              var news = _step3.value;
              var sourceIndex = lodash__WEBPACK_IMPORTED_MODULE_2__["findIndex"](this.newsSources, {
                source: news.source
              });
        ...
        value: function handleRank() {
          ...
          try {
            for (var _iterator4 = this.dataBank[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
              var news = _step4.value;
          ...
          rankedNews.sort(function (a, b) {
            return a.rank - b.rank;
          }); // rankedNews = this.shuffleNews(rankedNews);

          this.dataBank = [].concat(rankedNews, unrankedNews);
        ...
        key: "duplicateCheck",
        value: function duplicateCheck(news) {
          return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0,
          /*#__PURE__*/
            ...
            return regeneratorRuntime.wrap(function _callee3$(_context3) {
              while (1) {
                switch (_context3.prev = _context3.next) {
                  case 0:
                    _context3.next = 2;
                    return this.duplicateTitleCheck(news);
                  ...
                  case 5:
                    _context3.next = 7;
                    return this.duplicateBodyCheck(news);
                  ...
                  case 10:
                    _context3.next = 12;
                    return this.duplicateURLCheck(news);
        ...
        key: "duplicateTitleCheck",
        value: function duplicateTitleCheck(news) {
          var duplicateTitleIndex = lodash__WEBPACK_IMPORTED_MODULE_2__["findIndex"](this.dataBank, {
            title: news.title
          });
        ...
        key: "duplicateBodyCheck",
        value: function duplicateBodyCheck(news) {
          var duplicateBodyIndex = lodash__WEBPACK_IMPORTED_MODULE_2__["findIndex"](this.dataBank, {
            body: news.body
          });
        ...
        key: "duplicateURLCheck",
        value: function duplicateURLCheck(news) {
          var duplicateUrlIndex = lodash__WEBPACK_IMPORTED_MODULE_2__["findIndex"](this.dataBank, {
            link: news.link
          });
        ...
        key: "duplicateHandler",
        value: function duplicateHandler(duplicateProp) {
          return sweetalert2__WEBPACK_IMPORTED_MODULE_4___default.a.fire({
            title: "Duplicated ".concat(duplicateProp),
    ...
    EditorService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([tslib__WEBPACK_IMPORTED_MODULE_0__["__param"](0, Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"])(ngx_webstorage_service__WEBPACK_IMPORTED_MODULE_3__["LOCAL_STORAGE"]))], EditorService);
    /***/
  },
  ...
  function srcAppEditorEditorComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function EditorComponent(formBuilder, editorService) {
      ...
      _createClass(EditorComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.editorService.selectData.subscribe(function (res) {
            _this2.selectedData = res.news;
            _this2.index = res.index;

            _this2.patchData(res.news);
          });
        ...
        value: function update() {
          if (this.editorForm.valid) {
            var data = this.editorForm.value;
              ...
              while (1) {
                switch (_context4.prev = _context4.next) {
                  case 0:
                    ...
                    _context4.next = 4;
                    return this.editorService.duplicateCheck(data);

                  case 4:
                    mindTheDuplicate = _context4.sent;
        ...
        value: function clear() {
          ...
          sweetalert2__WEBPACK_IMPORTED_MODULE_4___default.a.fire({
            ...
            if (result.value) {
              _this3.editorService.clearItems();
            }
          });
        }
      }, {
        key: "subscribeToSourceChanges",
        value: function subscribeToSourceChanges() {
          var _this4 = this;

          this.filteredSources = this.editorForm.controls["source"].valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["startWith"])(""), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (value) {
            return _this4.filter(value);
          }));
        }
      }, {
        key: "filter",
        value: function filter(value) {
          ...
          return this.sources.filter(function (option) {
        ...
        value: function subscribeToSource() {
          ...
          this.editorService.newSourceAdded.subscribe(function (res) {
            _this5.sources = res;
          });
        }
      }]);
  ...
  function srcAppSortSortComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function SortComponent(editorService) {
      ...
      _createClass(SortComponent, [{
        ...
        key: "delete",
        value: function _delete(index, item) {
          var _this6 = this;

          sweetalert2__WEBPACK_IMPORTED_MODULE_3___default.a.fire({
            title: "Delete ".concat(item.title),
            text: "Are you sure?",
            type: "error",
            confirmButtonText: "Delete",
            confirmButtonColor: "#f44336",
            ...
            if (result.value) {
              _this6.editorService.removeOne(index);
            }
          });
        }
      }, {
        key: "edit",
        value: function edit(i, item) {
    ...
    SortComponent.ctorParameters = function () {
      return [{
        type: _editor_service__WEBPACK_IMPORTED_MODULE_2__["EditorService"]
      }];
    };
  ...
  /***/
  function srcAppViewerViewerComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppViewerViewerComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    /*#__PURE__*/
    function () {
      function ViewerComponent(editorService) {
    ...
    ViewerComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-viewer',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./viewer.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/viewer/viewer.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./viewer.component.css */
      "./src/app/viewer/viewer.component.css")).default]
    })], ViewerComponent);
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /Users/markuy/Projects/HtmlFormatter/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
